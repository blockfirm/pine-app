...
/**
 * Gets all unredeemed lightning invoices from a user's Pine server.
 *
 ...
 */
const getUnredeemed = (credentials) => {
  ...
  const path = `/v1/users/${userId}/lightning/invoices/unredeemed`;
