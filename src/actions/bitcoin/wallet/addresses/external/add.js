...
export const BITCOIN_WALLET_ADDRESSES_EXTERNAL_ADD_SUCCESS = 'BITCOIN_WALLET_ADDRESSES_EXTERNAL_ADD_SUCCESS';
...
/**
 * Action to add a set of external bitcoin addresses to the state and persistent storage.
 *
