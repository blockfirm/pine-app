...
export const BITCOIN_WALLET_ADDRESSES_ADD_SUCCESS = 'BITCOIN_WALLET_ADDRESSES_ADD_SUCCESS';
...
/**
 * Action to add a set of bitcoin addresses to the state and persistent storage.
 *
