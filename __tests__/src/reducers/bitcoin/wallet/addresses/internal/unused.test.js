...
import internalUnusedReducer from '../../../../../../../src/reducers/bitcoin/wallet/addresses/internal/unused';

describe('internalUnusedReducer', () => {
  it('is a function', () => {
    expect(typeof internalUnusedReducer).toBe('function');
  });
  ...
  describe('when action is BITCOIN_WALLET_GET_UNUSED_ADDRESS_SUCCESS', () => {
    describe('when action.internal is true', () => {
      it('returns the action address', () => {
        ...
        const action = {
          type: walletActions.BITCOIN_WALLET_GET_UNUSED_ADDRESS_SUCCESS,
          address: '2398cb17-51d3-4624-a1f8-ed6063208c27',
          internal: true
        };

        const newState = internalUnusedReducer(oldState, action);
  ...
  describe('when state is not defined', () => {
    it('returns null', () => {
      const action = { type: 'UNKNOWN' };
      const newState = internalUnusedReducer(undefined, action);
