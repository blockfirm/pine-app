import setAvatar from '../../../../../src/PinePaymentProtocol/user/avatar/set';
...
describe('set', () => {
  ...
  describe('when uploading an avatar for address "timothy@pine.cash"', () => {
    ...
    describe('the HTTP request', () => {
      it('is made to the url https://_pine.pine.cash/v1/users/ACjpRHFv7L8iN4qnVeR4U7pyhzGxSr4Z2/avatar', () => {
        const expectedUrl = 'https://_pine.pine.cash/v1/users/ACjpRHFv7L8iN4qnVeR4U7pyhzGxSr4Z2/avatar';
      ...
      describe('the request options', () => {
        ...
        it('has header "Authorization" set to a signature of the request', () => {
          expect(options.headers).toBeTruthy();
          expect(options.headers['Authorization']).toBe('Basic QUNqcFJIRnY3TDhpTjRxblZlUjRVN3B5aHpHeFNyNFoyOkh5UXNUbmdhWmNwajFHRzlOWU52MW1JZnR1MW53SjVEaHM3clVJODNSZnRBZUUyenJTd2pYMlgraDF0Rk5MdG8xcU56VXdOMFp4NE90elZpWFc5bysyTT0=');
        });
