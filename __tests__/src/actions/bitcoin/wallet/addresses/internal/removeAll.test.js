import {
  ...
  BITCOIN_WALLET_ADDRESSES_INTERNAL_REMOVE_ALL_SUCCESS
} from '../../../../../../../src/actions/bitcoin/wallet/addresses/internal/removeAll';
...
describe('BITCOIN_WALLET_ADDRESSES_INTERNAL_REMOVE_ALL_SUCCESS', () => {
  it('equals "BITCOIN_WALLET_ADDRESSES_INTERNAL_REMOVE_ALL_SUCCESS"', () => {
    expect(BITCOIN_WALLET_ADDRESSES_INTERNAL_REMOVE_ALL_SUCCESS).toBe('BITCOIN_WALLET_ADDRESSES_INTERNAL_REMOVE_ALL_SUCCESS');
  });
});
...
describe('removeAll', () => {
  ...
  it('dispatches an action of type BITCOIN_WALLET_ADDRESSES_INTERNAL_REMOVE_ALL_SUCCESS', () => {
