...
import {
  ...
  BITCOIN_WALLET_ADDRESSES_EXTERNAL_SAVE_REQUEST,
  BITCOIN_WALLET_ADDRESSES_EXTERNAL_SAVE_SUCCESS,
  BITCOIN_WALLET_ADDRESSES_EXTERNAL_SAVE_FAILURE
} from '../../../../../../../src/actions/bitcoin/wallet/addresses/external/save';
...
describe('BITCOIN_WALLET_ADDRESSES_EXTERNAL_SAVE_REQUEST', () => {
  it('equals "BITCOIN_WALLET_ADDRESSES_EXTERNAL_SAVE_REQUEST"', () => {
    expect(BITCOIN_WALLET_ADDRESSES_EXTERNAL_SAVE_REQUEST).toBe('BITCOIN_WALLET_ADDRESSES_EXTERNAL_SAVE_REQUEST');
  });
});

describe('BITCOIN_WALLET_ADDRESSES_EXTERNAL_SAVE_SUCCESS', () => {
  it('equals "BITCOIN_WALLET_ADDRESSES_EXTERNAL_SAVE_SUCCESS"', () => {
    expect(BITCOIN_WALLET_ADDRESSES_EXTERNAL_SAVE_SUCCESS).toBe('BITCOIN_WALLET_ADDRESSES_EXTERNAL_SAVE_SUCCESS');
  });
});

describe('BITCOIN_WALLET_ADDRESSES_EXTERNAL_SAVE_FAILURE', () => {
  it('equals "BITCOIN_WALLET_ADDRESSES_EXTERNAL_SAVE_FAILURE"', () => {
    expect(BITCOIN_WALLET_ADDRESSES_EXTERNAL_SAVE_FAILURE).toBe('BITCOIN_WALLET_ADDRESSES_EXTERNAL_SAVE_FAILURE');
  });
});
...
describe('save', () => {
  ...
  it('dispatches an action of type BITCOIN_WALLET_ADDRESSES_EXTERNAL_SAVE_REQUEST', () => {
  ...
  it('serializes the addresses and saves it to AsyncStorage', () => {
    ...
    return saveAddresses()(dispatchMock, getStateMock).then(() => {
      ...
      expect(argument1).toBe(BITCOIN_ADDRESSES_EXTERNAL_STORAGE_KEY);
  ...
  it('dispatches an action of type BITCOIN_WALLET_ADDRESSES_EXTERNAL_SAVE_SUCCESS', () => {
    expect.hasAssertions();
  ...
  describe('when the function fails', () => {
    ...
    it('dispatches an action of type BITCOIN_WALLET_ADDRESSES_EXTERNAL_SAVE_FAILURE with the error', () => {
      expect.hasAssertions();
