import removeDeviceToken from '../../../../../src/PinePaymentProtocol/user/deviceTokens/remove';
...
const getStateMock = jest.fn(() => ({
  settings: {
    user: {
      profile: {
        pineAddress: '3baba460-2572-4596-945e-4c4c2a0ef3a4'
      }
    }
  },
  keys: {
...
jest.mock('../../../../../src/PinePaymentProtocol/user/deviceTokens/remove', () => {
    ...
    it('does not remove device token if there is no device token', () => {
      ...
      getStateMock.mockImplementationOnce(() => ({
        settings: {
          user: {
            profile: {
              pineAddress: '4e7e1ec1-cda6-4f17-801b-135c007633ad'
            }
          }
        },
        keys: {
