import getContactRequests from '../../../../../src/PinePaymentProtocol/user/contactRequests/get';
...
const getStateMock = jest.fn(() => ({
  settings: {
    user: {
      profile: {
        pineAddress: '7384fd3f-8c1b-4c7c-a21d-5edf8456648a'
      }
    }
  },
  keys: {
...
jest.mock('../../../../../src/PinePaymentProtocol/user/contactRequests/get', () => {
  ...
  describe('the returned function', () => {
    ...
    it('gets contact requests using the user\'s address and mnemonic', () => {
      ...
      return returnedFunction(dispatchMock, getStateMock).then(() => {
        ...
        expect(getContactRequests).toHaveBeenCalledWith(expectedPineAddress, expectedMnemonic);
      });
    });
